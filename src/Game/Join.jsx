export default function Join({ setPlayerName, setRoomId, onJoin }) {
    return (<div className='background d-flex justify-content-center align-items-center'>
        <div className="d-flex justify-content-center align-items-center">
            <form onSubmit={onJoin} className="text-center">
                ...
                <input id="room-code" onChange={(e) => setPlayerName(e.target.value)} type="text" className="form-control text-center mt-2" placeholder="Player Name" />
